...
#ifndef TRT_MAXPOOLINDICES_PLUGIN_H
#define TRT_MAXPOOLINDICES_PLUGIN_H
...
class MaxPoolIndicesPlugin final : public nvinfer1::IPluginV2DynamicExt
{
public:
...
class MaxPoolIndicesPluginCreator : public nvinfer1::IPluginCreator
{
public:
    MaxPoolIndicesPluginCreator();

    ~MaxPoolIndicesPluginCreator() override = default;
...
#endif // TRT_MAXPOOLINDICES_PLUGIN_H
